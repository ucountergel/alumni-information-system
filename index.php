...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.facebook.com/Ctu-ac-Alumni-Association-Incorporated-101148845151482/" target="_blank">Facebook</a></div></div>
        </footer>
